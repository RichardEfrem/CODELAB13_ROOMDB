package c14220270.paba.codelab13paba_roomdb.database
...
interface daftarBelanjaDAO {
    ...
    @Query("UPDATE daftarBelanja SET tanggal = :isi_tanggal, item = :isi_item, " +
            "jumlah = :isi_jumlah, status = :isi_status WHERE id = :pilihId")
    fun update(isi_tanggal: String, isi_item: String, isi_jumlah: String,
               isi_status: Int, pilihId: Int)
